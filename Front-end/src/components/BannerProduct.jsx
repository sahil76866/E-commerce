    ...
    return (
        <div className='container mx-auto px-4 rounded  '>
            <div className=" h-56 md:h-80 w-full bg-slate-200 relative">
                        ...
                        desktopImages.map((imageURL, index) => {
                            return (
                                <div
                                    ...
                                    className='w-full h-full  min-w-full  translate transition-all'
                                    key={imageURL}>


                                    <img src={imageURL} alt="" className='w-full h-full' />{currentImage}
                ...
                <div className=' flex h-full w-full overflow-hidden md:hidden rounded'>
                    {
